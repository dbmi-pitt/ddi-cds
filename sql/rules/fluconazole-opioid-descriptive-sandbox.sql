...
SELECT de1.person_id, de1.drug_exposure_id AS op_dexp, de1.drug_concept_id AS op_id, c1.concept_name AS op_name, cs1.concept_name AS op_ingr, de1.drug_exposure_start_datetime AS op_start, de1.drug_exposure_end_datetime AS op_end, de1.quantity, de1.sig, de1.route_concept_id as op_route_id, de1.route_source_value as op_route,
...
AND ds1.ingredient_concept_id IN (select distinct concept_id from ohdsi.concept_set_item where concept_set_id = 7221) -- opioid ingredients
